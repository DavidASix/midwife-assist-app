...
class Settings extends Component {
  ...
  onPressStar(num) {
    ...
    if (num > 3) {
      ...
      setTimeout(() => Linking.openURL('https://play.google.com/store/apps/details?id=com.dave6.www.midwifeassist'), 400)
    } else {
  ...
  onPressSubmitComment = () => {
    ...
    setTimeout(() => ToastAndroid.showWithGravityAndOffset(
    ...
    for(let i = 0; i < 5; i++) {
      stars.push(
        <MIcons
          ...
          size={45}
          color={this.state.starSelected >= i+1 ? c.themes[theme].accent : c.themes[theme].text} />
      );
    }
    return stars;
  }
  ...
  renderRatingModal() {
    ...
    return (
      <SlideUpModal
        ...
        peek={0}>
        <Text style={{ color: c.themes[theme].text, marginVertical: 10 }}>Tell us what you think!</Text>

          {this.state.starSelected && this.state.starSelected < 4 ? (
            <>
              <TouchableOpacity
                style={[styles.row, { marginVertical: 10, justifyContent: 'center', backgroundColor: c.themes[theme].accent, borderColor: c.themes[theme].border }]}
                onPress={this.onPressSubmitComment}>
                <Text style={{ color: c.themes.dark.text }}>Submit Rating</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.row, { marginVertical: 10, justifyContent: 'center', backgroundColor: c.themes[theme].accent, borderColor: c.themes[theme].border }]}
                onPress={() => Linking.openURL('mailto:davidandersonsix@gmail.com?subject=Midwife Assist - Comment')}>
        ...
        <View style={[styles.container, { backgroundColor: c.themes[theme].background }]}>
          ...
          <View style={[styles.body, { backgroundColor: c.themes[theme].modal, borderColor: c.themes[theme].border }]}>
            ...
            <TouchableOpacity
              ...
              style={[styles.row, { backgroundColor: c.themes[theme].background, borderColor: c.themes[theme].border }]}>
          ...
          <View style={[styles.body, { backgroundColor: c.themes[theme].modal, borderColor: c.themes[theme].border }]}>
            ...
            <TouchableOpacity
              onPress={() => Linking.openURL('mailto:davidandersonsix@gmail.com?subject=Regarding Midwife Assist App')}
              style={[styles.row, { backgroundColor: c.themes[theme].background, borderColor: c.themes[theme].border }]}>
              <Text style={[styles.buttonText, { color: c.themes[theme].text }]}>
                Contact Developer
              </Text>
