      ...
      case 'gbs': {
        return (
          <>
            <View style={[styles.row, { paddingVertical: 5, justifyContent: 'space-around' }]}>
              <TouchableOpacity
                onPress={() => this.setState({ scrubbedGbs: 'positive' })}
                style={{
                  height: size,
                  width: size,
                  borderRadius: size / 2,
              ...
              <TouchableOpacity
                onPress={() => this.setState({ scrubbedGbs: 'negative' })}
                style={{
                  height: size,
                  width: size,
                  borderRadius: size / 2,
              ...
              <TouchableOpacity
                onPress={() => this.setState({ scrubbedGbs: 'unknown' })}
                style={{
                  height: size,
                  width: size,
                  borderRadius: size / 2,
      ...
      <View style={styles.container}>
        <View style={[styles.modal, { backgroundColor: c.themes[theme].background, borderColor: c.themes[theme].border }]}>
          <TouchableOpacity style={[styles.row, c.center, { justifyContent: 'space-between'}]} onPress={() => this.props.navigation.pop()}>
            <Text style={[styles.rowText, textColor, { flex: 1 }]}>
